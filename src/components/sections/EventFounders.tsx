...
const EventFounders: React.FC = () => {
  ...
  return (
    <div className="min-vh-100 our-team-page-bg py-5" style={{ background: 'linear-gradient(135deg,rgb(0, 0, 0) 0%,rgb(0, 0, 0) 50%,rgb(87, 32, 32) 100%)', color: '#fff', overflow: 'hidden' }}>
            ...
            <div className="col-md-4 col-12 d-flex flex-column align-items-center mb-4" key={founder.name}>
              ...
              >
                ...
                <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0, padding: '1.5rem 1rem 1rem 1rem', background: 'linear-gradient(0deg, rgba(0,0,0,0.85) 70%, rgba(241, 85, 0, 0.0) 100%)', color: '#fff' }}>
                  ...
                  <div style={{ fontWeight: 500, fontSize: 16, marginBottom: 8 }}>{founder.title} | {founder.year}</div>
                </div>
              </div>
            </div>
          ))}
                ...
                <div className="modal-content" style={{
                  ...
                  <div className="modal-body row">
                    <div className="col-md-5 col-12 mb-3 mb-md-0 d-flex align-items-center justify-content-center">
                      <img src={selected.image} alt={selected.name} className="rounded-circle w-100" style={{ maxWidth: 320, objectFit: 'cover', border: '4px solid #fff' }} />
                    </div>
                    <div className="col-md-7 col-12">
                      <div className="mb-2 fw-semibold" style={{ color: '#fff' }}>{selected.title}</div>
                      {selected.bio && selected.bio.map((line, i) => (
      ...
      <style>{`
        .founder-hover-zoom:hover {
          transform: scale(1.045);
          z-index: 2;
        }
        .founder-hover-zoom:hover img {
